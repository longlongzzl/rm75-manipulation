...
最新补充：[三场景无运动后续：PushT GPU 完整链、PickPlace 固定回归、Jimu 深度恢复](CODEX_THREE_SCENE_NOMOTION_20260907.md)；前轮：[PickPlace 多物体与 PushT 实际 GPU 回传](CODEX_PICKPLACE_PUSHT_LOCAL_20260907.md)、[Jimu 相机 RRTrack 与 PickPlace 退让回传](CODEX_JIMU_RRTRACK_AND_CLEARANCE_20260907.md)。下文为历史轮次，勿将其旧计数当作最新结果。
