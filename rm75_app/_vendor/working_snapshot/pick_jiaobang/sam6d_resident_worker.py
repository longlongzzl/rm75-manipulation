...
def main() -> None:
    ...
    parser.add_argument("--template-cache-root", type=str, default="/home/zhangzhao/Desktop/rm75-manipulation/rm75_app/_vendor/working_snapshot/pick_jiaobang/sam6d_template_cache")
    parser.add_argument("--pem-feature-cache-root", type=str, default="/home/zhangzhao/Desktop/rm75-manipulation/rm75_app/_vendor/working_snapshot/pick_jiaobang/sam6d_pem_feature_cache")
