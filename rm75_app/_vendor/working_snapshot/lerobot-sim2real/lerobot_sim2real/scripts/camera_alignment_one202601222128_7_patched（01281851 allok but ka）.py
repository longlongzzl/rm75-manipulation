...
class Args:
    ...
    # camera_extrinsic_opencv_path: Optional[str] = "/home/zhangzhao/Desktop/rm75-manipulation/rm75_app/_vendor/working_snapshot/rm75_pick_place_app/assets/calibration/camera_extrinsic_opencv.npy"
