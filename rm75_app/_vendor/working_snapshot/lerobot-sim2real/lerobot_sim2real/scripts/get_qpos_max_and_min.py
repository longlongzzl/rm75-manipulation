...
def update_camera(sim_env):
    ...
    target = sim_env.unwrapped.base_camera_settings["target"]

    sim_env.unwrapped.base_camera_settings["target"] = sim_env.unwrapped.base_camera_settings["target"] + camera_target_offset
