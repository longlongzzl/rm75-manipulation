...
class SO101(BaseAgent):
    uid = "so101"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/so101/SO_5DOF_ARM101_8j/so101_mod2_with_gripper_collision_cvx.urdf"

    #urdf_path = f"{PACKAGE_ASSET_DIR}/robots/so101/new_SO101/so101_new_calib_wo_handeye.urdf"
    urdf_config = dict(
        _materials=dict(
    ...
    load_multiple_collisions = True  # Load multiple collisions for the gripper links
    ...
    def _after_loading_articulation(self):
        ...
        # self.finger1_link = self.robot.links_map["gripper_frame_link"]
