...
#        p_on_support = [-0.014463, 0.016458, 0.00053]
        ...
        self.tcp = get_link("gripper_base_link")
        if self.tcp is None:
            self.tcp = get_link("link_7")
    ...
    def is_grasping(self, object: Actor, min_force=0.5, max_angle=92):
       ...
       # print("111", torch.rad2deg(langle), torch.rad2deg(rangle))
