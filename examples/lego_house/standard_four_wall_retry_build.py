...
STRATEGY_PRESET_VALUES = {
    ...
    "pair_first_mined_light_v1": {
        ...
        "fast_chain_pair_probe_all_coupled_tilt": True,
    ...
    "pair_first_cuda64_keypose_v1": {
        "max_release_candidates": 30,
        "fast_screen_max_release_candidates": 30,
        "fast_screen_max_grasp_candidates": 14,
        "fast_screen_ik_seeds": 64,
        "fast_chain_top_grasp_candidates": 6,
        "fast_chain_top_release_candidates": 4,
        "fast_chain_ik_seeds": 64,
        "fast_chain_pair_probe_candidates": 4,
        "fast_chain_stop_pair_probe_after_success": True,
        "fast_chain_min_successful_pair_probes": 0,
        "fast_chain_center_distance_weight": 0.28,
        ...
        "inline_child_planner": True,
        "use_cuda_graph_batch_ik": True,
        "cuda_graph_batch_ik_max_batch": 64,
        "cuda_graph_batch_ik_fixed_batch_size": 64,
        "free_space_motion_window": False,
        "free_space_pregrasp_max_waypoints": 12,
        "free_space_return_neutral_steps": 3,
        "free_space_return_neutral_max_joint_step": 0.12,
    ...
    "pair_first_graph_intersection_v1": {
        "max_release_candidates": 30,
        "fast_screen_max_release_candidates": 30,
        "fast_screen_max_grasp_candidates": 14,
        "fast_screen_ik_seeds": 64,
        ...
        "fast_chain_release_probe_weight": 0.6,
        "fast_chain_supported_wall_max_actor_to_tcp_y": 0.0,
        "fast_chain_pair_intersection_screening": True,
        "fast_chain_pair_intersection_max_grasps": 4,
        "fast_chain_pair_intersection_max_pairs": 64,
        "release_candidate_indices": (
            "right_wall:16;17;15;2;3;5;12;14;1;28,"
            "back_wall:5;16;3;2;17;15;12;14;1;28,"
            "left_wall:16;5;2;17;15;3;12;14;1;28,"
    ...
    "pair_first_graph_angle64_v1": {
        "max_release_candidates": 48,
        "max_grasp_candidates": 64,
        "fast_screen_max_release_candidates": 48,
        "fast_screen_max_grasp_candidates": 64,
        "fast_screen_ik_seeds": 64,
        "fast_chain_top_grasp_candidates": 8,
        "fast_chain_top_release_candidates": 6,
        "fast_chain_ik_seeds": 64,
        ...
        "fast_chain_release_probe_weight": 0.6,
        "fast_chain_supported_wall_max_actor_to_tcp_y": 0.0,
        "fast_chain_grasp_tilt_weight": 0.02,
        "fast_chain_prefer_zero_tilt_pairs": True,
        "fast_chain_pair_intersection_screening": True,
        "fast_chain_pair_intersection_max_grasps": 8,
        "fast_chain_pair_intersection_max_pairs": 64,
        "release_candidate_indices": (
            "right_wall:16;17;15;2;3;5;12;14;1;28,"
            "back_wall:5;16;3;2;17;15;12;14;1;28,"
        ...
        "wall_grasp_prior_mode": "mined_success_v1",
        "wall_grasp_prior_max_candidates": 16,
        "wall_grasp_extra_tilt_degs": "4,-4,8,-8",
        "wall_grasp_extra_tilt_max_abs_deg": 14.0,
        "fixed_top_down_extra_tilt_degs": "4,-4,8,-8",
        "fixed_top_down_extra_tilt_max_abs_deg": 14.0,
        "fixed_top_down_extra_tilt_lift_mms": "0.5,1.0,2.0",
        "fixed_top_down_extra_tilt_normal_bias_mms": "0.0,1.0,-1.0,2.0,-2.0",
        "couple_wall_grasp_release_tilt": True,
        "release_robust_actor_to_tcp_y_offsets": "0.0,0.008,-0.008",
        "release_robust_actor_to_tcp_x_offsets": "0.0",
        "release_robust_actor_to_tcp_z_offsets": "0.0",
        "release_robust_actor_to_tcp_yaw_deg_offsets": "0.0",
    ...
    "pair_first_graph_center_angle64_v1": {
        "max_release_candidates": 30,
        "max_grasp_candidates": 16,
        "fast_screen_max_release_candidates": 30,
        "fast_screen_max_grasp_candidates": 16,
        "fast_screen_ik_seeds": 32,
        "fast_chain_top_grasp_candidates": 6,
        "fast_chain_top_release_candidates": 4,
        "fast_chain_ik_seeds": 32,
        ...
        "fast_chain_release_probe_weight": 0.6,
        "fast_chain_supported_wall_max_actor_to_tcp_y": 0.0,
        "fast_chain_center_angle_degs": "0,15,30,45",
        "fast_chain_center_angle_candidates_per_angle": 16,
        "fast_chain_center_angle_weight": 0.002,
        "fast_chain_center_angle_pair_weight": 0.01,
        "fast_chain_prefer_zero_center_angle_pairs": True,
        "fast_chain_pair_intersection_group_by_center_angle": True,
        "fast_chain_pair_intersection_grasps_per_center_angle": 1,
        "fast_chain_pair_intersection_screening": True,
        "fast_chain_pair_intersection_max_grasps": 4,
        "fast_chain_pair_intersection_max_pairs": 64,
        "release_candidate_indices": (
        ...
        "wall_release_profile": "fixed_top_down",
        "fixed_top_down_open_gap": 0.006,
        "wall_release_approach_mode": "top_down",
        "require_active_connection_before_open": False,
    },
    "pair_first_graph_center_angle64_seed64_v1": {
        "max_release_candidates": 30,
        "max_grasp_candidates": 16,
        "fast_screen_max_release_candidates": 30,
        "fast_screen_max_grasp_candidates": 16,
        ...
        "fast_chain_center_angle_pair_weight": 0.01,
        "fast_chain_prefer_zero_center_angle_pairs": True,
        "fast_chain_center_angle_zero_first_gate": True,
        "fast_chain_pair_intersection_group_by_center_angle": True,
        "fast_chain_pair_intersection_grasps_per_center_angle": 1,
        "fast_chain_pair_intersection_screening": True,
        "fast_chain_pair_intersection_max_grasps": 4,
...
def _apply_strategy_preset(args: argparse.Namespace, defaults: dict[str, Any]) -> None:
    ...
    if preset_name in {
        ...
        if (
            preset_name == "pair_first_robust_fast_v1"
            and dx > 0.005
            and dy < -0.001
            and bool(getattr(args, "use_cuda_graph_batch_ik", False))
        ):
...
GRASP_RESTAGE_DIRECT_FAILURES = {
    "physical_grasp_check",
    "physical_grasp_lost_during_lift",
}
GRASP_RESTAGE_CANDIDATE_FAILURES = {
    "pregrasp_motion_plan",
    "edge_grasp_ik",
    "edge_grasp_joint_branch_jump",
    "lift_ik",
    "lift_joint_branch_jump",
}
GRASP_RESTAGE_RELEASE_FAILURES = {
    "release_screen",
    "release_screen_preplace_branch_jump",
    "release_motion_plan",
    "no_robust_grasp_release_pair",
    "live_release_place_ik_fail",
    "preplace_joint_branch_jump",
    "place_joint_branch_jump",
    "single_connection_place_joint_delta",
    "predicted_actor_pose_gate",
    "fixed_single_connection_release_too_close",
}


def _candidate_failed_at_values(report: dict[str, Any]) -> list[str]:
    values: list[str] = []
    for candidate_report in report.get("candidate_reports") or []:
        if not isinstance(candidate_report, dict):
            continue
        failed_at = str(candidate_report.get("failed_at") or "")
        if failed_at:
            values.append(failed_at)
        release_screen = candidate_report.get("release_screen")
        if isinstance(release_screen, dict):
            release_failed_at = str(release_screen.get("failed_at") or "")
            if release_failed_at:
                values.append(release_failed_at)
    return values


def _is_grasp_restage_trigger(summary: dict[str, Any] | None) -> tuple[bool, dict[str, Any]]:
    if not summary or summary.get("read_error"):
        return False, {"reason": "missing_summary"}
    reports = summary.get("reports")
    report = reports[-1] if isinstance(reports, list) and reports else {}
    if not isinstance(report, dict):
        return False, {"reason": "missing_role_report"}
    failed_at = str(report.get("failed_at") or "")
    failure_classification = str(report.get("failure_classification") or "")
    detail: dict[str, Any] = {
        "failed_at": failed_at,
        ...
        "candidate_report_count": len(report.get("candidate_reports") or []),
    }
    if failed_at in GRASP_RESTAGE_DIRECT_FAILURES:
        detail["reason"] = "direct_grasp_runtime_failure"
        return True, detail
    if failed_at != "candidate_screen":
        detail["reason"] = "not_candidate_or_grasp_failure"
        return False, detail

    counts: dict[str, int] = {}
    grasp_count = 0
    release_count = 0
    for value in _candidate_failed_at_values(report):
        counts[value] = counts.get(value, 0) + 1
        if value in GRASP_RESTAGE_CANDIDATE_FAILURES:
            grasp_count += 1
        if value in GRASP_RESTAGE_RELEASE_FAILURES:
            release_count += 1
    detail["candidate_failures"] = counts
    detail["grasp_failure_count"] = grasp_count
    detail["release_failure_count"] = release_count
    if grasp_count <= 0:
        detail["reason"] = "no_grasp_candidate_failures"
        return False, detail
    if failure_classification in GRASP_RESTAGE_RELEASE_FAILURES and grasp_count < release_count:
        detail["reason"] = "release_dominant_failure"
        return False, detail
    detail["reason"] = "grasp_dominant_candidate_failure"
    return True, detail


def _should_try_grasp_restage_fallback(attempt_records: list[dict[str, Any]]) -> tuple[bool, dict[str, Any]]:
    checked: list[dict[str, Any]] = []
    for attempt_record in attempt_records:
        summary_path = attempt_record.get("summary_path")
        summary = _read_json(Path(summary_path)) if summary_path else None
        trigger, detail = _is_grasp_restage_trigger(summary)
        checked.append(
            {
                "attempt_number": attempt_record.get("attempt_number"),
                "role_attempt": attempt_record.get("role_attempt"),
                "success": attempt_record.get("success"),
        ...
        if trigger:
            return True, {"trigger_attempt": attempt_record.get("attempt_number"), "checked": checked}
    return False, {"checked": checked}


def _restage_summary_has_valid_grasp(summary: dict[str, Any] | None) -> tuple[bool, dict[str, Any]]:
    if not summary or summary.get("read_error"):
        return False, {"reason": "missing_summary"}
    reports = summary.get("reports")
    report = reports[-1] if isinstance(reports, list) and reports else {}
    if not isinstance(report, dict):
        return False, {"reason": "missing_role_report"}
    after_close = report.get("grasp_after_close")
    after_lift = report.get("grasp_after_lift")
    close_ok = bool(after_close.get("is_grasped")) if isinstance(after_close, dict) else False
    lift_ok = bool(after_lift.get("is_grasped")) if isinstance(after_lift, dict) else True
    detail = {
        "failed_at": report.get("failed_at"),
        "close_ok": close_ok,
        "lift_ok": lift_ok,
        "grasp_after_close": after_close if isinstance(after_close, dict) else None,
        "grasp_after_lift": after_lift if isinstance(after_lift, dict) else None,
    }
    if not close_ok:
        detail["reason"] = "close_grasp_check_failed"
        return False, detail
    if not lift_ok:
        detail["reason"] = "lift_grasp_check_failed"
        return False, detail
    detail["reason"] = "valid_physical_grasp"
    return True, detail


def _merge_restaged_state(
    *,
    original_state_path: Path,
    restaged_state_path: Path,
    merged_state_path: Path,
    role: str,
    completed: list[str],
) -> dict[str, Any]:
    original = _read_json(original_state_path)
    restaged = _read_json(restaged_state_path)
    if not original or original.get("read_error"):
        raise RuntimeError(f"Could not read original state: {original_state_path}")
    if not restaged or restaged.get("read_error"):
        raise RuntimeError(f"Could not read restaged state: {restaged_state_path}")
    original_role_states = original.get("role_states")
    restaged_role_states = restaged.get("role_states")
    if not isinstance(original_role_states, dict) or not isinstance(restaged_role_states, dict):
        raise RuntimeError("Assembly state missing role_states")
    if role not in restaged_role_states:
        raise RuntimeError(f"Restaged state does not contain role {role}")
    merged = json.loads(json.dumps(original))
    merged_roles = list(dict.fromkeys([*list(merged.get("roles") or []), role]))
    merged["roles"] = merged_roles
    merged["completed_roles"] = list(dict.fromkeys(completed))
    merged["role_states"][role] = restaged_role_states[role]
    if "robot_qpos" in restaged:
        merged["robot_qpos"] = restaged["robot_qpos"]
    merged_state_path.parent.mkdir(parents=True, exist_ok=True)
    merged_state_path.write_text(json.dumps(_json_ready(merged), ensure_ascii=False, indent=2), encoding="utf-8")
    return {
        "original_state": str(original_state_path),
        "restaged_state": str(restaged_state_path),
        "merged_state": str(merged_state_path),
        "role": role,
        "completed_roles": list(dict.fromkeys(completed)),
    }
...
def _base_child_args(args: argparse.Namespace, planning_budget: dict[str, Any], execution_budget: dict[str, Any]) -> list[str]:
    child_args = [
        ...
        (
            ...
            if bool(getattr(args, "couple_wall_grasp_release_tilt", False))
            else "--no-couple-wall-grasp-release-tilt"
        ),
        ...
        "--fast-chain-pair-probe-all-coupled-tilt"
        if bool(getattr(args, "fast_chain_pair_probe_all_coupled_tilt", True))
        else "--no-fast-chain-pair-probe-all-coupled-tilt",
        ...
        "--fast-chain-grasp-tilt-weight",
        str(getattr(args, "fast_chain_grasp_tilt_weight", 0.0)),
        (
            "--fast-chain-prefer-zero-tilt-pairs"
            if bool(getattr(args, "fast_chain_prefer_zero_tilt_pairs", False))
            else "--no-fast-chain-prefer-zero-tilt-pairs"
        ),
        "--fast-chain-center-angle-degs",
        str(getattr(args, "fast_chain_center_angle_degs", "")),
        "--fast-chain-center-angle-max-abs-deg",
        str(getattr(args, "fast_chain_center_angle_max_abs_deg", 45.0)),
        "--fast-chain-center-angle-candidates-per-angle",
        str(getattr(args, "fast_chain_center_angle_candidates_per_angle", 0)),
        "--fast-chain-center-angle-weight",
        str(getattr(args, "fast_chain_center_angle_weight", 0.0)),
        "--fast-chain-center-angle-pair-weight",
        str(getattr(args, "fast_chain_center_angle_pair_weight", 0.0)),
        (
            "--fast-chain-prefer-zero-center-angle-pairs"
            if bool(getattr(args, "fast_chain_prefer_zero_center_angle_pairs", False))
            else "--no-fast-chain-prefer-zero-center-angle-pairs"
        ),
        (
            "--fast-chain-center-angle-zero-first-gate"
            if bool(getattr(args, "fast_chain_center_angle_zero_first_gate", False))
            else "--no-fast-chain-center-angle-zero-first-gate"
        ),
        (
            "--fast-chain-pair-intersection-group-by-center-angle"
            if bool(getattr(args, "fast_chain_pair_intersection_group_by_center_angle", False))
            else "--no-fast-chain-pair-intersection-group-by-center-angle"
        ),
        "--fast-chain-pair-intersection-grasps-per-center-angle",
        str(getattr(args, "fast_chain_pair_intersection_grasps_per_center_angle", 1)),
        "--fast-chain-pair-intersection-screening"
        if bool(getattr(args, "fast_chain_pair_intersection_screening", False))
        else "--no-fast-chain-pair-intersection-screening",
        "--fast-chain-pair-intersection-max-grasps",
        str(getattr(args, "fast_chain_pair_intersection_max_grasps", 4)),
        "--fast-chain-pair-intersection-max-pairs",
        str(getattr(args, "fast_chain_pair_intersection_max_pairs", 64)),
    ...
    if float(getattr(args, "initial_actor_jitter_xy", 0.0) or 0.0) > 0.0:
        ...
        if (
            float(getattr(args, "initial_actor_jitter_safe_x_min", 0.0) or 0.0)
            < float(getattr(args, "initial_actor_jitter_safe_x_max", 0.0) or 0.0)
            and float(getattr(args, "initial_actor_jitter_safe_y_min", 0.0) or 0.0)
            < float(getattr(args, "initial_actor_jitter_safe_y_max", 0.0) or 0.0)
        ):
            child_args.extend(
                [
                    "--initial-actor-jitter-safe-x-min",
                    str(args.initial_actor_jitter_safe_x_min),
                    "--initial-actor-jitter-safe-x-max",
                    str(args.initial_actor_jitter_safe_x_max),
                    "--initial-actor-jitter-safe-y-min",
                    str(args.initial_actor_jitter_safe_y_min),
                    "--initial-actor-jitter-safe-y-max",
                    str(args.initial_actor_jitter_safe_y_max),
                ]
            )
        if (
            float(getattr(args, "initial_actor_jitter_center_x_min", 0.0) or 0.0)
            < float(getattr(args, "initial_actor_jitter_center_x_max", 0.0) or 0.0)
            and float(getattr(args, "initial_actor_jitter_center_y_min", 0.0) or 0.0)
            < float(getattr(args, "initial_actor_jitter_center_y_max", 0.0) or 0.0)
        ):
            child_args.extend(
                [
                    "--initial-actor-jitter-center-x-min",
                    str(args.initial_actor_jitter_center_x_min),
                    "--initial-actor-jitter-center-x-max",
                    str(args.initial_actor_jitter_center_x_max),
                    "--initial-actor-jitter-center-y-min",
                    str(args.initial_actor_jitter_center_y_min),
                    "--initial-actor-jitter-center-y-max",
                    str(args.initial_actor_jitter_center_y_max),
                ]
            )
    return child_args
...
def _build_grasp_restage_command(
    *,
    args: argparse.Namespace,
    role: str,
    attempt_dir: Path,
    ...
    planning_budget = {
        "mode": "grasp_restage",
        "max_release_candidates": int(getattr(args, "grasp_restage_max_release_candidates", 10)),
        "max_grasp_candidates": int(getattr(args, "grasp_restage_max_grasp_candidates", 24)),
        "ik_seeds": int(getattr(args, "grasp_restage_ik_seeds", 24)),
        "diversify_wall_grasp_candidates": True,
    }
    execution_budget = _execution_budget_for_attempt(args, max(int(getattr(args, "max_attempts_per_role", 2)), 1))
    restage_args = argparse.Namespace(**vars(args))
    restage_args.wall_release_profile = "fixed_top_down"
    restage_args.fixed_top_down_open_gap = float(getattr(args, "grasp_restage_fixed_top_down_open_gap", 0.006))
    restage_args.wall_grasp_extra_tilt_degs = ""
    restage_args.fixed_top_down_extra_tilt_degs = ""
    restage_args.wall_grasp_prior_mode = "none"
    restage_args.wall_grasp_prior_max_candidates = 0
    restage_args.pre_open_min_active_connections = 0
    restage_args.require_active_connection_before_open = False
    restage_args.pre_open_connection_correction_attempts = 0
    restage_args.release_correction_attempts = 0
    release_ignore_roles = str(getattr(args, "grasp_restage_release_ignore_roles", "floor") or "floor")
    command = [
        restage_args.python,
        restage_args.planner_script,
        "--out-dir",
        str(attempt_dir),
        "--roles",
        role,
        ...
        "--save-assembly-completed-roles",
        ",".join(completed),
        "--save-assembly-on-failure-roles",
        role,
        "--load-assembly-state",
        str(state_in),
        "--restore-loaded-magnetic-connections",
        ...
        release_ignore_roles,
        "--square-wall-grasp-edge-axis",
        str(getattr(args, "grasp_restage_grasp_edge_axis", "y")),
        "--no-prefer-center-wall-grasp",
        "--grasp-candidate-start-index",
        str(getattr(args, "grasp_restage_grasp_candidate_start_index", 1)),
        "--wall-grasp-prior-mode",
        "none",
        "--wall-grasp-prior-max-candidates",
        "0",
        ...
        role,
        "--override-target-x",
        str(getattr(args, "grasp_restage_target_x", -0.500)),
        "--override-target-y",
        str(getattr(args, "grasp_restage_target_y", -0.190)),
        "--override-target-z",
        str(getattr(args, "grasp_restage_target_z", 0.037)),
        "--override-target-qw",
        str(getattr(args, "grasp_restage_target_qw", 0.4999998211860657)),
        "--override-target-qx",
        str(getattr(args, "grasp_restage_target_qx", 0.4999997913837433)),
        "--override-target-qy",
        str(getattr(args, "grasp_restage_target_qy", 0.5000019073486328)),
        "--override-target-qz",
        str(getattr(args, "grasp_restage_target_qz", 0.4999985694885254)),
        *_base_child_args(restage_args, planning_budget, execution_budget),
    ]
    if bool(getattr(args, "runtime_collision_monitor", False)):
        command.append("--runtime-collision-monitor")
    else:
        command.append("--no-runtime-collision-monitor")
    if bool(args.no_rear_collision_wall):
        command.append("--no-add-rear-collision-wall")
    else:
        command.extend(
    ...
    metadata = {
        "candidate": {
            "name": "grasp_restage_fixed_pose",
            "role": role,
            "grasp_axis": str(getattr(args, "grasp_restage_grasp_edge_axis", "y")),
            "target_position": [
                float(getattr(args, "grasp_restage_target_x", -0.500)),
                float(getattr(args, "grasp_restage_target_y", -0.190)),
                float(getattr(args, "grasp_restage_target_z", 0.037)),
            ],
            "target_quaternion": [
                float(getattr(args, "grasp_restage_target_qw", 0.4999998211860657)),
                float(getattr(args, "grasp_restage_target_qx", 0.4999997913837433)),
                float(getattr(args, "grasp_restage_target_qy", 0.5000019073486328)),
                float(getattr(args, "grasp_restage_target_qz", 0.4999985694885254)),
            ],
        },
        "planning_budget": planning_budget,
        "execution_budget": execution_budget,
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        ...
        "planning": {
            ...
            "initial_actor_jitter": {
                ...
                "center_bounds": {
                    "x_min": float(getattr(args, "initial_actor_jitter_center_x_min", 0.0) or 0.0),
                    "x_max": float(getattr(args, "initial_actor_jitter_center_x_max", 0.0) or 0.0),
                    "y_min": float(getattr(args, "initial_actor_jitter_center_y_min", 0.0) or 0.0),
                    "y_max": float(getattr(args, "initial_actor_jitter_center_y_max", 0.0) or 0.0),
                },
            },
            "grasp_restage_fallback": {
                "enabled": bool(getattr(args, "enable_grasp_restage_fallback", False)),
                "after_attempts": int(getattr(args, "grasp_restage_after_attempts", 3) or 3),
                "target_position": [
                    float(getattr(args, "grasp_restage_target_x", -0.500)),
                    float(getattr(args, "grasp_restage_target_y", -0.190)),
                    float(getattr(args, "grasp_restage_target_z", 0.037)),
                ...
                "grasp_edge_axis": str(getattr(args, "grasp_restage_grasp_edge_axis", "y")),
            },
        },
    ...
    if args.execution_mode in {"direct-first", "direct-only"} and roles:
        ...
        if success:
            ...
            if len(completed) == len(roles):
                ...
                return report
            report_path.write_text(json.dumps(_json_ready(report), ensure_ascii=False, indent=2), encoding="utf-8")
        if direct_completed and state_out.exists():
    ...
    for role in roles:
        if role in completed:
            continue
        role_success = False
        role_attempt_records: list[dict[str, Any]] = []
        for role_attempt in range(args.max_attempts_per_role):
            ...
            report["attempts"].append(attempt_record)
            role_attempt_records.append(attempt_record)
            report_path.write_text(json.dumps(_json_ready(report), ensure_ascii=False, indent=2), encoding="utf-8")
            ...
            if success:
                ...
                break
        if not role_success:
            restage_decision = {"enabled": bool(getattr(args, "enable_grasp_restage_fallback", False))}
            if bool(getattr(args, "enable_grasp_restage_fallback", False)) and state_in is not None:
                role_attempt_min = max(int(getattr(args, "grasp_restage_after_attempts", 3) or 3), 1)
                enough_attempts = len(role_attempt_records) >= role_attempt_min
                trigger, trigger_detail = _should_try_grasp_restage_fallback(role_attempt_records)
                restage_decision.update(
                    {
                        "role": role,
                        "enough_attempts": enough_attempts,
                        "after_attempts": role_attempt_min,
                        "trigger": trigger,
                        "trigger_detail": trigger_detail,
                    }
                )
                report.setdefault("grasp_restage_fallbacks", []).append(dict(restage_decision))
                report_path.write_text(json.dumps(_json_ready(report), ensure_ascii=False, indent=2), encoding="utf-8")
                if enough_attempts and trigger:
                    restage_index = len(report.get("grasp_restage_fallbacks", []))
                    restage_dir = out_dir / "restage_fallbacks" / f"restage_{restage_index:03d}_{role}"
                    restaged_state = checkpoints_dir / f"restage_{restage_index:03d}_{role}_raw_state.json"
                    restage_command, restage_metadata = _build_grasp_restage_command(
                        args=args,
                        role=role,
                        attempt_dir=restage_dir,
                        state_in=state_in,
                        state_out=restaged_state,
                        completed=completed,
                    )
                    restage_record: dict[str, Any] = {
                        "attempt_number": None,
                        "role": role,
                        "mode": "grasp_restage",
                        "started_at": _now(),
                        "attempt_dir": str(restage_dir),
                        "command": restage_command,
                        **restage_metadata,
                    }
                    _append_log(log_path, f"[{_now()}] start grasp_restage role={role}")
                    returncode, timed_out, child_stdout, child_stderr = _run_child_process(
                        command=restage_command,
                        attempt_dir=restage_dir,
                        cwd=Path(args.planner_script).resolve().parent,
                    ...
                    restage_summary_path = restage_dir / "multi_wall_summary.json"
                    restage_summary = _read_json(restage_summary_path)
                    restage_failure = _classify_failure(restage_summary, returncode)
                    restage_video = str(restage_dir / "multi_wall_live.mp4") if (restage_dir / "multi_wall_live.mp4").exists() else None
                    restage_valid_grasp, restage_grasp_detail = _restage_summary_has_valid_grasp(restage_summary)
                    restage_state_available = restaged_state.exists() and restage_valid_grasp
                    restage_record.update(
                        {
                            "finished_at": _now(),
                            "elapsed_since_start_sec": round(time.perf_counter() - started, 3),
                            "returncode": returncode,
                            "timed_out": timed_out,
                            "summary_path": str(restage_summary_path) if restage_summary_path.exists() else None,
                            "stdout_path": str(child_stdout),
                            "stderr_path": str(child_stderr),
                            "video": restage_video,
                            "success": bool(restage_state_available),
                            "classification": restage_failure,
                            "valid_grasp_for_merge": restage_valid_grasp,
                            "grasp_validation": restage_grasp_detail,
                        }
                    )
                    report["attempts"].append(restage_record)
                    _append_log(
                        log_path,
                        f"[{_now()}] finish grasp_restage role={role} state_available={restage_state_available} class={restage_failure.get('kind')}",
                    )
                    if restage_state_available:
                        merged_state = checkpoints_dir / f"restage_{restage_index:03d}_{role}_merged_state.json"
                        try:
                            merge_info = _merge_restaged_state(
                                original_state_path=state_in,
                                restaged_state_path=restaged_state,
                                merged_state_path=merged_state,
                                role=role,
                                completed=completed,
                            )
                            restage_record["merged_state"] = merge_info
                            attempt_number += 1
                            retry_attempt_dir = attempts_dir / f"attempt_{attempt_number:03d}_{role}_after_restage"
                            retry_state_out = checkpoints_dir / f"attempt_{attempt_number:03d}_{role}_after_restage_state.json"
                            retry_schedule_index = max(args.max_attempts_per_role, role_attempt_min)
                            retry_command, retry_metadata = _build_command(
                                args=args,
                                role=role,
                                attempt_dir=retry_attempt_dir,
                                state_in=merged_state,
                                state_out=retry_state_out,
                                completed=completed,
                                attempt_index=retry_schedule_index,
                            )
                            retry_record: dict[str, Any] = {
                                "attempt_number": attempt_number,
                                "role": role,
                                "mode": "build_after_grasp_restage",
                                "role_attempt": len(role_attempt_records) + 1,
                                "schedule_attempt_index": retry_schedule_index,
                                "started_at": _now(),
                                "attempt_dir": str(retry_attempt_dir),
                                "command": retry_command,
                                **retry_metadata,
                            }
                            report_path.write_text(json.dumps(_json_ready(report), ensure_ascii=False, indent=2), encoding="utf-8")
                            _append_log(log_path, f"[{_now()}] start build_after_grasp_restage attempt={attempt_number} role={role}")
                            returncode, timed_out, child_stdout, child_stderr = _run_child_process(
                                command=retry_command,
                                attempt_dir=retry_attempt_dir,
                                cwd=Path(args.planner_script).resolve().parent,
                            ...
                            retry_summary_path = retry_attempt_dir / "multi_wall_summary.json"
                            retry_summary = _read_json(retry_summary_path)
                            retry_failure = _classify_failure(retry_summary, returncode)
                            retry_success = bool(
                                retry_summary
                                and retry_summary.get("final", {}).get("success")
                                and returncode == 0
                                and retry_state_out.exists()
                            )
                            retry_record.update(
                                {
                                    "finished_at": _now(),
                                    ...
                                    "returncode": returncode,
                                    "timed_out": timed_out,
                                    "summary_path": str(retry_summary_path) if retry_summary_path.exists() else None,
                                    "stdout_path": str(child_stdout),
                                    "stderr_path": str(child_stderr),
                                    "video": str(retry_attempt_dir / "multi_wall_live.mp4") if (retry_attempt_dir / "multi_wall_live.mp4").exists() else None,
                                    "success": retry_success,
                                    "classification": retry_failure,
                                    "restage_source": restage_record.get("attempt_dir"),
                                    "restage_video": restage_record.get("video"),
                                }
                            )
                            report["attempts"].append(retry_record)
                            _append_log(
                                log_path,
                                f"[{_now()}] finish build_after_grasp_restage attempt={attempt_number} role={role} success={retry_success} class={retry_failure.get('kind')}",
                            )
                            if retry_success:
                                stable_state = checkpoints_dir / f"stable_{len(completed) + 1:02d}_{role}_state.json"
                                shutil.copy2(retry_state_out, stable_state)
                                completed.append(role)
                                state_in = stable_state
                                report["successes"].append(
                                    {
                                        ...
                                        "attempt_number": attempt_number,
                                        "stable_state": str(stable_state),
                                        "video": retry_record["video"],
                                        "summary_path": retry_record["summary_path"],
                                        "candidate": retry_metadata["candidate"],
                                        "grasp_restage_fallback": True,
                                        "restage_video": restage_record.get("video"),
                                    }
                                )
                                report["final"] = {
                                    ...
                                    "completed_roles": completed,
                                    "latest_stable_state": str(state_in),
                                    "latest_video": retry_record["video"],
                                }
                                report_path.write_text(json.dumps(_json_ready(report), ensure_ascii=False, indent=2), encoding="utf-8")
                                role_success = True
                        except Exception as exc:
                            restage_record["merge_or_retry_error"] = f"{type(exc).__name__}: {exc}"
                            _append_log(log_path, f"[{_now()}] grasp_restage merge/retry error role={role}: {type(exc).__name__}: {exc}")
                    report_path.write_text(json.dumps(_json_ready(report), ensure_ascii=False, indent=2), encoding="utf-8")
            if role_success:
                continue
            report["final"] = {
...
def main() -> None:
    ...
    parser.add_argument("--enable-grasp-restage-fallback", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--grasp-restage-after-attempts", type=int, default=3)
    parser.add_argument("--grasp-restage-target-x", type=float, default=-0.500)
    parser.add_argument("--grasp-restage-target-y", type=float, default=-0.190)
    parser.add_argument("--grasp-restage-target-z", type=float, default=0.037)
    parser.add_argument("--grasp-restage-target-qw", type=float, default=0.4999998211860657)
    parser.add_argument("--grasp-restage-target-qx", type=float, default=0.4999997913837433)
    parser.add_argument("--grasp-restage-target-qy", type=float, default=0.5000019073486328)
    parser.add_argument("--grasp-restage-target-qz", type=float, default=0.4999985694885254)
    parser.add_argument("--grasp-restage-grasp-edge-axis", choices=["x", "y"], default="y")
    parser.add_argument("--grasp-restage-grasp-candidate-start-index", type=int, default=1)
    parser.add_argument("--grasp-restage-release-ignore-roles", default="floor")
    parser.add_argument("--grasp-restage-fixed-top-down-open-gap", type=float, default=0.006)
    parser.add_argument("--grasp-restage-max-release-candidates", type=int, default=10)
    parser.add_argument("--grasp-restage-max-grasp-candidates", type=int, default=24)
    parser.add_argument("--grasp-restage-ik-seeds", type=int, default=24)
